...
public final class HeartBeatGrpc {
  ...
  public static final String SERVICE_NAME = "cn.ladd.grpcx.register.heartbeat.common.HeartBeat";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<cn.ladd.grpcx.register.heartbeat.common.BeatRequest,
      cn.ladd.grpcx.register.heartbeat.common.Empty> METHOD_BEAT =
      io.grpc.MethodDescriptor.<cn.ladd.grpcx.register.heartbeat.common.BeatRequest, cn.ladd.grpcx.register.heartbeat.common.Empty>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "cn.ladd.grpcx.register.heartbeat.common.HeartBeat", "beat"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              cn.ladd.grpcx.register.heartbeat.common.BeatRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              cn.ladd.grpcx.register.heartbeat.common.Empty.getDefaultInstance()))
  ...
  public static abstract class HeartBeatImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void beat(cn.ladd.grpcx.register.heartbeat.common.BeatRequest request,
        io.grpc.stub.StreamObserver<cn.ladd.grpcx.register.heartbeat.common.Empty> responseObserver) {
    ...
    public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                cn.ladd.grpcx.register.heartbeat.common.BeatRequest,
                cn.ladd.grpcx.register.heartbeat.common.Empty>(
                  this, METHODID_BEAT)))
          .build();
    }
  }
  ...
  public static final class HeartBeatBlockingStub extends io.grpc.stub.AbstractStub<HeartBeatBlockingStub> {
    ...
    /**
     */
    public cn.ladd.grpcx.register.heartbeat.common.Empty beat(cn.ladd.grpcx.register.heartbeat.common.BeatRequest request) {
  ...
  public static final class HeartBeatFutureStub extends io.grpc.stub.AbstractStub<HeartBeatFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<cn.ladd.grpcx.register.heartbeat.common.Empty> beat(
        cn.ladd.grpcx.register.heartbeat.common.BeatRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_BEAT:
          serviceImpl.beat((cn.ladd.grpcx.register.heartbeat.common.BeatRequest) request,
              (io.grpc.stub.StreamObserver<cn.ladd.grpcx.register.heartbeat.common.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class HeartBeatBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cn.ladd.grpcx.register.heartbeat.common.HeartBeatOuterClass.getDescriptor();
    }
